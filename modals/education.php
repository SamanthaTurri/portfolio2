<dialog id="modal-education" aria-labelledby="modal-education-title" aria-describedby="modal-education-desc">
    <article class="modal-content">
        ...
        <div id="modal-education-desc">
            ...
            <div class="modal-item">
                <h3>Coding</h3>
                    <ul>
                        <li>Hand-coded projects in HTML, CSS, Javascript and PHP.</li>
                        <li>Developed custom WordPress block themes.</li>
                        <li>Used a third-party API to dynamically populate my React project.</li>
                    </ul>
            </div>
            <div class="modal-item">
